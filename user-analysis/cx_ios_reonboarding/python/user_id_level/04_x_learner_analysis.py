...
scores_df = df_encoded[['user_id', 'tag', 'result', 'is_treatment']].copy()
...
# Upload to Snowflake
table_name = 'proddb.fionafan.cx_ios_reonboarding_xlearner_scores_user_level'
...
💾 SNOWFLAKE TABLE:
   • proddb.fionafan.cx_ios_reonboarding_xlearner_scores_user_level
     (Contains CATE scores for all users)
