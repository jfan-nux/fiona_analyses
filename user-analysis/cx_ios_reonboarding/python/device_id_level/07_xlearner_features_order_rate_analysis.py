    ...
    if bin_sql:
        ...
        metrics AS (
            SELECT
                ...
                SUM(has_order_post_exposure) AS success_count,
                AVG(has_order_post_exposure) * 100.0 AS order_rate
            FROM proddb.fionafan.cx_ios_reonboarding_master_features m
...
def main():
    ...
    csv_path = '/Users/fiona.fan/Documents/fiona_analyses/user-analysis/cx_ios_reonboarding/outputs/device_id_level/04_xlearner_residual_feature_importance.csv'
    ...
    # Create PDF
    output_pdf = '/Users/fiona.fan/Documents/fiona_analyses/user-analysis/cx_ios_reonboarding/plots/device_id_level/xlearner_features_order_rate_lift.pdf'
