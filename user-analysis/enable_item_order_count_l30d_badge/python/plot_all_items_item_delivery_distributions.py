...
def plot_distributions(df: pd.DataFrame) -> Path:
    ...
    axes = axes.flatten()
    windows = [
        ("deliveries_30d", "30-Day Deliveries per Item (All Items)"),
        ("deliveries_60d", "60-Day Deliveries per Item (All Items)"),
        ("deliveries_90d", "90-Day Deliveries per Item (All Items)"),
        ("deliveries_120d", "120-Day Deliveries per Item (All Items)"),
        ("deliveries_150d", "150-Day Deliveries per Item (All Items)"),
        ("deliveries_180d", "180-Day Deliveries per Item (All Items)"),
    ]
    ...
    outfile = plots_dir / f"all_items_item_delivery_distributions_6windows_{timestamp}.png"
