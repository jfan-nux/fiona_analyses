...
/*---------------------------------------------------------------
  2. Store-item level orders in analysis window
----------------------------------------------------------------*/
...
/*---------------------------------------------------------------
  5. Combine; keep only store-item combinations that have a badge bucket
----------------------------------------------------------------*/
joined AS (
    SELECT
        b.volume_bin,
...
/*---------------------------------------------------------------
  6. Metrics by (bin, group) - Store-Item Level
----------------------------------------------------------------*/
metrics AS (
    SELECT
        volume_bin,
...
/*---------------------------------------------------------------
  9. Percent-diff-to-control for each treatment arm (Store-Item Level)
----------------------------------------------------------------*/
bin_diffs AS (
    SELECT
        t.volume_bin,
