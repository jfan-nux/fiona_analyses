...
select business_id, business_name, store_id from dimension_store where business_name in (
  ...
  'Chocolats Favoris',
  '2941 Street Food',
  'Hungry Howie''s Pizza (Amberly Dr)',
  ...
  'Hangry Joe''s Hot Chicken & Wings Montgomery Village',
  'Indian Masala House',
  'Marco''s Pizza & Family Restaurant',
  'WNB Factory - Wings Burgers Tenders',
  'Nudy''s Cafe',
  'Marco''s Pizza - Los Filtros',
  'INDIAN MASALA TADKA',
  'Indian Masala Bar & Grill - Squamish',
  'Chili''s South Indian Cuisine',
  'Miami Grill',
  'Taco Time LLC',
  'Wanpo Tea Shop Stonestown',
  'Pho Town (McDonough)',
  'Pho Town 6',
  'Indian Masala Bistro - Whistler',
  'Taco Time Mexican Grill',
  'Firehouse Subs Stockyards',
  'Pho Town 7',
  'Marco’s Pizza',
  'Little Caesars Express',
  'Mis Padres Mexican Grill Dutchtown',
  'Subway Arana Hills',
  'Indian masala house',
  'Indian Masala house',
  'Subway Cafe',
  'Pho Town',
  'Lao Sze Chuan & Te''amo - 5150 Buford Hwy Ne',
  'Pho Town (Alpharetta)',
  'Taco time',
  'taco time and more',
  'Little Caesars Pizza',
  'Boost Juice Lakelands',
  'Boost Juice Rockingham',
  'George''s BBQ By Ghost Kitchens',
  'Boost Juice Ellenbrook',
  'Boost Juice Perth Train Station',
  'Boost Juice Gungahlin',
  'Boost Juice Ed Square',
  'BP Mart & Little Caesar',
  'Ubora Coffee',
  'Indian Masala Palace',
  'Subway West Gosford Village',
  'Boost Juice Belconnen',
  'Boost Juice Rockdale',
  'Boost Juice Warwick Grove',
  'Subway - 4845',
  'Boost Juice Canberra Centre',
  'Hawker Fare',
  'SUBWAY',
  'Kian Food LLC',
