...
def create_toc_page(pdf, pivot_categories):
    ...
    # Footer
    ax.text(0.5, 0.05, 'Each section contains 4 charts:', 
            ha='center', va='bottom', fontsize=10, style='italic')
    ax.text(0.5, 0.03, 
            '1) % Messages with Tag  2) Open Rate*  3) Unsubscribe Rate*  4) Uninstall Rate*',
...
def create_pivot_section(pdf, df, pivot_by):
    """Create a 4-chart section for one pivot_by category."""
