...
# MAGIC %md
# MAGIC # Predict Week 3-4 Presence from First Session Features + Second Session Return
# MAGIC
...
# MAGIC **PLUS whether they had a second session in weeks 1-2**.
# MAGIC
...
# MAGIC 2. Add second session feature (only counting sessions in weeks 1-2)
...
# MAGIC %md
# MAGIC ## Load Data with Week 3-4 Presence Target and Second Session (Weeks 1-2 Only)
...
print("📊 Loading first session data with second session feature (weeks 1-2 only)...")
...
print(f"{'Cohort Type':<20} {'Total Sessions':<15} {'Week 3-4':<12} {'% Week 3-4':<12} {'Had 2nd Session':<15}")
print("-" * 80)
...
for row in cohort_summary:
    ...
    print(f"{cohort:<20} {total:<15,} {week_3_4:<12,} {pct:<12.2f}% {had_2nd:<15,}")
...
output_table = "first_session_week_3_4_presence_with_second_session_prediction_results"
