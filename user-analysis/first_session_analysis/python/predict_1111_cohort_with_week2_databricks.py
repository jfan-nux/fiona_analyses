...
# MAGIC %md
# MAGIC # Predict 1111 Cohort Membership from First Session Features + Week 2 Return
# MAGIC
...
# MAGIC %md
# MAGIC ## Load Data with 1111 Cohort Target and Week 2 Return
...
print(f"{'Cohort Type':<20} {'Total Sessions':<15} {'In 1111':<12} {'% in 1111':<12} {'Returned Week 2':<15}")
print("-" * 80)
...
for row in cohort_summary:
    ...
    print(f"{cohort:<20} {total:<15,} {in_1111:<12,} {pct:<12.2f}% {returned_w2:<15,}")
...
output_table = "first_session_1111_with_week2_prediction_results"
