...
with open('../sql/eta_analysis_fast.sql', 'r') as f:
    query = f.read()
...
fig.suptitle('Speed Store Card Experiment: ETA Analysis - FAST RESTAURANTS ONLY (Treatment vs Control)', 
...
plt.tight_layout()
plt.savefig('../output/eta_analysis_fast_plot.png', dpi=300, bbox_inches='tight')
print("Plot saved to ../output/eta_analysis_fast_plot.png")

# Print summary statistics using overall data
print("\n=== Summary Statistics (Overall) - FAST RESTAURANTS ONLY ===")
print(f"\nDelivery Count Lift:")
