...
-- FILTERED TO NON-FAST RESTAURANTS ONLY
...
with daily_metrics as (
    ...
    inner join proddb.fionafan.speed_store_card_and_row_experiment_tagged_stores_rx_non_fast_Restaurants non_fast_stores
        on d.store_id = non_fast_stores.store_id
