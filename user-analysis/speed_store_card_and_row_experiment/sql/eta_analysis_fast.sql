...
-- FILTERED TO FAST RESTAURANTS ONLY
...
with daily_metrics as (
    ...
    inner join proddb.fionafan.speed_store_card_and_row_experiment_tagged_stores_rx_fast_Restaurants fast_stores
        on d.store_id = fast_stores.store_id
